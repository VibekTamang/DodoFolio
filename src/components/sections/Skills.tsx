export default function Skills() {
  return (
    <section className="w-screen md:w-[120vw] min-h-screen py-24 md:py-0 flex flex-col md:flex-row items-center justify-start gap-12 md:gap-20 px-6 md:px-24 shrink-0 relative group border-b md:border-b-0 md:border-r border-[#222]">
